...
void test_crow_probability_powers() {
    ...
    TRY(x = 0);      y = -1;     TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0);      y = -0.25;  TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0);      y = 0;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0);      y = 0.25;   TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0);      y = 0.75;   TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0);      y = 1;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0);      y = 1.25;   TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0);      y = 2;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0);      y = 3;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.125);  y = -1;     TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.125);  y = -0.25;  TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.125);  y = 0;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.125);  y = 0.25;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.0328317899, 1e-10);
    TRY(x = 0.125);  y = 0.75;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.0952969806, 1e-10);
    TRY(x = 0.125);  y = 1;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.125);
    TRY(x = 0.125);  y = 1.25;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.1537278161, 1e-10);
    TRY(x = 0.125);  y = 2;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.234375);
    TRY(x = 0.125);  y = 3;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.330078125);
    TRY(x = 0.375);  y = -1;     TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.375);  y = -0.25;  TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.375);  y = 0;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.375);  y = 0.25;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.1108602950, 1e-10);
    TRY(x = 0.375);  y = 0.75;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.2970733435, 1e-10);
    TRY(x = 0.375);  y = 1;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.375);
    TRY(x = 0.375);  y = 1.25;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.4442876844, 1e-10);
    TRY(x = 0.375);  y = 2;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.609375);
    TRY(x = 0.375);  y = 3;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.755859375);
    TRY(x = 0.5);    y = -1;     TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.5);    y = -0.25;  TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.5);    y = 0;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.5);    y = 0.25;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.1591035847, 1e-10);
    TRY(x = 0.5);    y = 0.75;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.4053964425, 1e-10);
    TRY(x = 0.5);    y = 1;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.5);
    TRY(x = 0.5);    y = 1.25;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.5795517924, 1e-10);
    TRY(x = 0.5);    y = 2;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.75);
    TRY(x = 0.5);    y = 3;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.875);
    TRY(x = 0.625);  y = -1;     TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.625);  y = -0.25;  TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.625);  y = 0;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.625);  y = 0.25;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.2174577100, 1e-10);
    TRY(x = 0.625);  y = 0.75;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.5207926718, 1e-10);
    TRY(x = 0.625);  y = 1;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.625);
    TRY(x = 0.625);  y = 1.25;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.7065466412, 1e-10);
    TRY(x = 0.625);  y = 2;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.859375);
    TRY(x = 0.625);  y = 3;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.947265625);
    TRY(x = 0.875);  y = -1;     TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.875);  y = -0.25;  TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.875);  y = 0;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0);
    TRY(x = 0.875);  y = 0.25;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.4053964425, 1e-10);
    TRY(x = 0.875);  y = 0.75;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.7897758962, 1e-10);
    TRY(x = 0.875);  y = 1;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.875);
    TRY(x = 0.875);  y = 1.25;   TRY(z = cmp_pow(x, y));  TEST_NEAR(z.value(), 0.9256745553, 1e-10);
    TRY(x = 0.875);  y = 2;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.984375);
    TRY(x = 0.875);  y = 3;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 0.998046875);
    TRY(x = 1);      y = 0.25;   TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 1);
    TRY(x = 1);      y = 0.75;   TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 1);
    TRY(x = 1);      y = 1;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 1);
    TRY(x = 1);      y = 1.25;   TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 1);
    TRY(x = 1);      y = 2;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 1);
    TRY(x = 1);      y = 3;      TRY(z = cmp_pow(x, y));  TEST_EQUAL(z.value(), 1);
