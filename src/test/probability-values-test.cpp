...
void test_crow_probability_formatting() {
    ...
    TRY(p = 0.25);             TRY(s = p.str());      TEST_EQUAL(s, "0.25");
    TRY(p = 0.5);              TRY(s = p.str());      TEST_EQUAL(s, "0.5");
    TRY(p = 0.75);             TRY(s = p.str());      TEST_EQUAL(s, "0.75");
    ...
    TRY(p = 0);                TRY(s = p.str("Pz"));  TEST_EQUAL(s, "0");
    TRY(p = 0.0000123456789);  TRY(s = p.str("Pz"));  TEST_EQUAL(s, "0.00123457");
    TRY(p = 0.000123456789);   TRY(s = p.str("Pz"));  TEST_EQUAL(s, "0.0123457");
    TRY(p = 0.00123456789);    TRY(s = p.str("Pz"));  TEST_EQUAL(s, "0.123457");
    TRY(p = 0.0123456789);     TRY(s = p.str("Pz"));  TEST_EQUAL(s, "1.23457");
    TRY(p = 0.123456789);      TRY(s = p.str("Pz"));  TEST_EQUAL(s, "12.3457");
    TRY(p = 0.25);             TRY(s = p.str("Pz"));  TEST_EQUAL(s, "25");
    TRY(p = 0.5);              TRY(s = p.str("Pz"));  TEST_EQUAL(s, "50");
    TRY(p = 0.75);             TRY(s = p.str("Pz"));  TEST_EQUAL(s, "75");
    TRY(p = 0.87654321);       TRY(s = p.str("Pz"));  TEST_EQUAL(s, "87.6543");
    TRY(p = 0.987654321);      TRY(s = p.str("Pz"));  TEST_EQUAL(s, "98.76543");
    TRY(p = 0.9987654321);     TRY(s = p.str("Pz"));  TEST_EQUAL(s, "99.876543");
    TRY(p = 0.99987654321);    TRY(s = p.str("Pz"));  TEST_EQUAL(s, "99.9876543");
    TRY(p = 0.999987654321);   TRY(s = p.str("Pz"));  TEST_EQUAL(s, "99.99876543");
    TRY(p = 1);                TRY(s = p.str("Pz"));  TEST_EQUAL(s, "100");
