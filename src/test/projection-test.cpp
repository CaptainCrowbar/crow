...
void test_crow_projection_azimuthal_equidistant() {
    ...
    TEST_EQUAL(expand(proj.properties()), "azimuthal,sphere,circle,hemisphere-circle");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(proj.has_min_y());
    TEST(proj.has_max_y());
...
void test_crow_projection_gnomonic() {
    ...
    TEST_EQUAL(expand(proj.properties()), "azimuthal,sub-hemisphere,plane");
    TEST(! proj.has_min_x());
    TEST(! proj.has_max_x());
    TEST(! proj.has_min_y());
    TEST(! proj.has_max_y());
...
void test_crow_projection_lambert_azimuthal() {
    ...
    TEST_EQUAL(expand(proj.properties()), "azimuthal,sphere,circle,equal-area,hemisphere-circle");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(proj.has_min_y());
    TEST(proj.has_max_y());
...
void test_crow_projection_orthographic() {
    ...
    TEST_EQUAL(expand(proj.properties()), "azimuthal,hemisphere,circle,hemisphere-circle");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(proj.has_min_y());
    TEST(proj.has_max_y());
...
void test_crow_projection_stereographic() {
    ...
    TEST_EQUAL(expand(proj.properties()), "azimuthal,sub-sphere,plane,conformal,hemisphere-circle");
    TEST(! proj.has_min_x());
    TEST(! proj.has_max_x());
    TEST(! proj.has_min_y());
    TEST(! proj.has_max_y());
...
void test_crow_projection_cylindrical_equidistant() {
    ...
    TEST_EQUAL(expand(proj.properties()), "cylindrical,sphere,rectangle");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(proj.has_min_y());
    TEST(proj.has_max_y());
...
void test_crow_projection_gall_peters() {
    ...
    TEST_EQUAL(expand(proj.properties()), "cylindrical,sphere,rectangle,equal-area");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(proj.has_min_y());
    TEST(proj.has_max_y());
...
void test_crow_projection_mercator() {
    ...
    TEST_EQUAL(expand(proj.properties()), "cylindrical,sub-sphere,other-shape,conformal");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(! proj.has_min_y());
    TEST(! proj.has_max_y());
...
void test_crow_projection_eckert_iv() {
    ...
    TEST_EQUAL(expand(proj.properties()), "pseudocylindrical,sphere,other-shape,equal-area,numerical");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(proj.has_min_y());
    TEST(proj.has_max_y());
...
void test_crow_projection_mollweide() {
    ...
    TEST_EQUAL(expand(proj.properties()), "pseudocylindrical,sphere,ellipse,equal-area,hemisphere-circle,numerical");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(proj.has_min_y());
    TEST(proj.has_max_y());
...
void test_crow_projection_sinusoidal() {
    ...
    TEST_EQUAL(expand(proj.properties()), "pseudocylindrical,sphere,other-shape,equal-area");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(proj.has_min_y());
    TEST(proj.has_max_y());
...
void test_crow_projection_interrupted_eckert_iv() {
    ...
    TEST_EQUAL(expand(proj.properties()), "pseudocylindrical,sphere,other-shape,equal-area,interrupted,numerical");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(proj.has_min_y());
    TEST(proj.has_max_y());
...
void test_crow_projection_interrupted_sinusoidal() {
    ...
    TEST_EQUAL(expand(proj.properties()), "pseudocylindrical,sphere,other-shape,equal-area,interrupted");
    TEST(proj.has_min_x());
    TEST(proj.has_max_x());
    TEST(proj.has_min_y());
    TEST(proj.has_max_y());
