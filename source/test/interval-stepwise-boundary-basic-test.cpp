...
using B = Boundary<Stepwise>;
using BT = BoundaryType;

void test_crow_interval_stepwise_boundary_formatting() {
...
void test_crow_interval_stepwise_boundary_from_interval() {
...
void test_crow_interval_stepwise_boundary_to_interval() {
