...
void test_crow_interval_ordered_boundary_formatting() {
...
void test_crow_interval_ordered_boundary_from_interval() {
...
void test_crow_interval_ordered_boundary_to_interval() {
