...
void test_crow_interval_ordered_interval_basic_properties() {
...
void test_crow_interval_ordered_interval_construction() {
...
void test_crow_interval_ordered_interval_from_string() {
...
void test_crow_interval_ordered_interval_order() {
...
void test_crow_interval_ordered_interval_complement() {
...
void test_crow_interval_ordered_interval_binary_operations() {
    ...
    static const std::vector<test_info> tests = {
        ...
        { __LINE__,  {" "," ","*"},   {},              gt,  false,  false,  false,  "*",      "{}",     "{*}",            "{*}",            "{*}",            },
        { __LINE__,  {" "," ","*"},   {" "," ","*"},   eq,  true,   true,   true,   "*",      "*",      "{*}",            "{}",             "{}",             },
        { __LINE__,  {"b"},           {},              gt,  false,  false,  false,  "b",      "{}",     "{b}",            "{b}",            "{b}",            },
        { __LINE__,  {"b"},           {" "," ","*"},   gt,  false,  true,   true,   "*",      "b",      "{*}",            "{}",             "{<b,>b}",        },
        { __LINE__,  {"b"},           {"a"},           gt,  false,  false,  false,  "[a,b]",  "{}",     "{a,b}",          "{b}",            "{a,b}",          },
        { __LINE__,  {"b"},           {"b"},           eq,  true,   true,   true,   "b",      "b",      "{b}",            "{}",             "{}",             },
        { __LINE__,  {"b"},           {"c"},           lt,  false,  false,  false,  "[b,c]",  "{}",     "{b,c}",          "{b}",            "{b,c}",          },
        { __LINE__,  {"b","b","<"},   {},              gt,  false,  false,  false,  "<b",     "{}",     "{<b}",           "{<b}",           "{<b}",           },
        { __LINE__,  {"b","b","<"},   {" "," ","*"},   lt,  false,  true,   true,   "*",      "<b",     "{*}",            "{}",             "{>=b}",          },
        { __LINE__,  {"b","b","<"},   {"a"},           lt,  true,   true,   true,   "<b",     "a",      "{<b}",           "{<a,(a,b)}",     "{<a,(a,b)}",     },
        { __LINE__,  {"b","b","<"},   {"b"},           lt,  false,  false,  true,   "<=b",    "{}",     "{<=b}",          "{<b}",           "{<=b}",          },
        { __LINE__,  {"b","b","<"},   {"c"},           lt,  false,  false,  false,  "<=c",    "{}",     "{<b,c}",         "{<b}",           "{<b,c}",         },
        { __LINE__,  {"b","b","<"},   {"a","a","<"},   gt,  true,   true,   true,   "<b",     "<a",     "{<b}",           "{[a,b)}",        "{[a,b)}",        },
        { __LINE__,  {"b","b","<"},   {"b","b","<"},   eq,  true,   true,   true,   "<b",     "<b",     "{<b}",           "{}",             "{}",             },
        { __LINE__,  {"b","b","<"},   {"c","c","<"},   lt,  false,  true,   true,   "<c",     "<b",     "{<c}",           "{}",             "{[b,c)}",        },
        { __LINE__,  {"b","b","<="},  {},              gt,  false,  false,  false,  "<=b",    "{}",     "{<=b}",          "{<=b}",          "{<=b}",          },
        { __LINE__,  {"b","b","<="},  {" "," ","*"},   lt,  false,  true,   true,   "*",      "<=b",    "{*}",            "{}",             "{>b}",           },
        { __LINE__,  {"b","b","<="},  {"a"},           lt,  true,   true,   true,   "<=b",    "a",      "{<=b}",          "{<a,(a,b]}",     "{<a,(a,b]}",     },
        { __LINE__,  {"b","b","<="},  {"b"},           lt,  true,   true,   true,   "<=b",    "b",      "{<=b}",          "{<b}",           "{<b}",           },
        { __LINE__,  {"b","b","<="},  {"c"},           lt,  false,  false,  false,  "<=c",    "{}",     "{<=b,c}",        "{<=b}",          "{<=b,c}",        },
        { __LINE__,  {"b","b","<="},  {"a","a","<"},   gt,  true,   true,   true,   "<=b",    "<a",     "{<=b}",          "{[a,b]}",        "{[a,b]}",        },
        { __LINE__,  {"b","b","<="},  {"b","b","<"},   gt,  true,   true,   true,   "<=b",    "<b",     "{<=b}",          "{b}",            "{b}",            },
        { __LINE__,  {"b","b","<="},  {"c","c","<"},   lt,  false,  true,   true,   "<c",     "<=b",    "{<c}",           "{}",             "{(b,c)}",        },
        { __LINE__,  {"b","b","<="},  {"a","a","<="},  gt,  true,   true,   true,   "<=b",    "<=a",    "{<=b}",          "{(a,b]}",        "{(a,b]}",        },
        { __LINE__,  {"b","b","<="},  {"b","b","<="},  eq,  true,   true,   true,   "<=b",    "<=b",    "{<=b}",          "{}",             "{}",             },
        { __LINE__,  {"b","b","<="},  {"c","c","<="},  lt,  false,  true,   true,   "<=c",    "<=b",    "{<=c}",          "{}",             "{(b,c]}",        },
        { __LINE__,  {"b","b",">"},   {},              gt,  false,  false,  false,  ">b",     "{}",     "{>b}",           "{>b}",           "{>b}",           },
        { __LINE__,  {"b","b",">"},   {" "," ","*"},   gt,  false,  true,   true,   "*",      ">b",     "{*}",            "{}",             "{<=b}",          },
        { __LINE__,  {"b","b",">"},   {"a"},           gt,  false,  false,  false,  ">=a",    "{}",     "{a,>b}",         "{>b}",           "{a,>b}",         },
        { __LINE__,  {"b","b",">"},   {"b"},           gt,  false,  false,  true,   ">=b",    "{}",     "{>=b}",          "{>b}",           "{>=b}",          },
        { __LINE__,  {"b","b",">"},   {"c"},           lt,  true,   true,   true,   ">b",     "c",      "{>b}",           "{(b,c),>c}",     "{(b,c),>c}",     },
        { __LINE__,  {"b","b",">"},   {"a","a","<"},   gt,  false,  false,  false,  "*",      "{}",     "{<a,>b}",        "{>b}",           "{<a,>b}",        },
        { __LINE__,  {"b","b",">"},   {"b","b","<"},   gt,  false,  false,  false,  "*",      "{}",     "{<b,>b}",        "{>b}",           "{<b,>b}",        },
        { __LINE__,  {"b","b",">"},   {"c","c","<"},   gt,  false,  true,   true,   "*",      "(b,c)",  "{*}",            "{>=c}",          "{<=b,>=c}",      },
        { __LINE__,  {"b","b",">"},   {"a","a","<="},  gt,  false,  false,  false,  "*",      "{}",     "{<=a,>b}",       "{>b}",           "{<=a,>b}",       },
        { __LINE__,  {"b","b",">"},   {"b","b","<="},  gt,  false,  false,  true,   "*",      "{}",     "{*}",            "{>b}",           "{*}",            },
        { __LINE__,  {"b","b",">"},   {"c","c","<="},  gt,  false,  true,   true,   "*",      "(b,c]",  "{*}",            "{>c}",           "{<=b,>c}",       },
        { __LINE__,  {"b","b",">"},   {"a","a",">"},   gt,  false,  true,   true,   ">a",     ">b",     "{>a}",           "{}",             "{(a,b]}",        },
        { __LINE__,  {"b","b",">"},   {"b","b",">"},   eq,  true,   true,   true,   ">b",     ">b",     "{>b}",           "{}",             "{}",             },
        { __LINE__,  {"b","b",">"},   {"c","c",">"},   lt,  true,   true,   true,   ">b",     ">c",     "{>b}",           "{(b,c]}",        "{(b,c]}",        },
        { __LINE__,  {"b","b",">="},  {},              gt,  false,  false,  false,  ">=b",    "{}",     "{>=b}",          "{>=b}",          "{>=b}",          },
        { __LINE__,  {"b","b",">="},  {" "," ","*"},   gt,  false,  true,   true,   "*",      ">=b",    "{*}",            "{}",             "{<b}",           },
        { __LINE__,  {"b","b",">="},  {"a"},           gt,  false,  false,  false,  ">=a",    "{}",     "{a,>=b}",        "{>=b}",          "{a,>=b}",        },
        { __LINE__,  {"b","b",">="},  {"b"},           gt,  true,   true,   true,   ">=b",    "b",      "{>=b}",          "{>b}",           "{>b}",           },
        { __LINE__,  {"b","b",">="},  {"c"},           lt,  true,   true,   true,   ">=b",    "c",      "{>=b}",          "{[b,c),>c}",     "{[b,c),>c}",     },
        { __LINE__,  {"b","b",">="},  {"a","a","<"},   gt,  false,  false,  false,  "*",      "{}",     "{<a,>=b}",       "{>=b}",          "{<a,>=b}",       },
        { __LINE__,  {"b","b",">="},  {"b","b","<"},   gt,  false,  false,  true,   "*",      "{}",     "{*}",            "{>=b}",          "{*}",            },
        { __LINE__,  {"b","b",">="},  {"c","c","<"},   gt,  false,  true,   true,   "*",      "[b,c)",  "{*}",            "{>=c}",          "{<b,>=c}",       },
        { __LINE__,  {"b","b",">="},  {"a","a","<="},  gt,  false,  false,  false,  "*",      "{}",     "{<=a,>=b}",      "{>=b}",          "{<=a,>=b}",      },
        { __LINE__,  {"b","b",">="},  {"b","b","<="},  gt,  false,  true,   true,   "*",      "b",      "{*}",            "{>b}",           "{<b,>b}",        },
        { __LINE__,  {"b","b",">="},  {"c","c","<="},  gt,  false,  true,   true,   "*",      "[b,c]",  "{*}",            "{>c}",           "{<b,>c}",        },
        { __LINE__,  {"b","b",">="},  {"a","a",">"},   gt,  false,  true,   true,   ">a",     ">=b",    "{>a}",           "{}",             "{(a,b)}",        },
        { __LINE__,  {"b","b",">="},  {"b","b",">"},   lt,  true,   true,   true,   ">=b",    ">b",     "{>=b}",          "{b}",            "{b}",            },
        { __LINE__,  {"b","b",">="},  {"c","c",">"},   lt,  true,   true,   true,   ">=b",    ">c",     "{>=b}",          "{[b,c]}",        "{[b,c]}",        },
        { __LINE__,  {"b","b",">="},  {"a","a",">="},  gt,  false,  true,   true,   ">=a",    ">=b",    "{>=a}",          "{}",             "{[a,b)}",        },
        { __LINE__,  {"b","b",">="},  {"b","b",">="},  eq,  true,   true,   true,   ">=b",    ">=b",    "{>=b}",          "{}",             "{}",             },
        { __LINE__,  {"b","b",">="},  {"c","c",">="},  lt,  true,   true,   true,   ">=b",    ">=c",    "{>=b}",          "{[b,c)}",        "{[b,c)}",        },
        { __LINE__,  {"b","d","()"},  {},              gt,  false,  false,  false,  "(b,d)",  "{}",     "{(b,d)}",        "{(b,d)}",        "{(b,d)}",        },
        { __LINE__,  {"b","d","()"},  {" "," ","*"},   gt,  false,  true,   true,   "*",      "(b,d)",  "{*}",            "{}",             "{<=b,>=d}",      },
        { __LINE__,  {"b","d","()"},  {"a"},           gt,  false,  false,  false,  "[a,d)",  "{}",     "{a,(b,d)}",      "{(b,d)}",        "{a,(b,d)}",      },
        { __LINE__,  {"b","d","()"},  {"b"},           gt,  false,  false,  true,   "[b,d)",  "{}",     "{[b,d)}",        "{(b,d)}",        "{[b,d)}",        },
        { __LINE__,  {"b","d","()"},  {"c"},           lt,  true,   true,   true,   "(b,d)",  "c",      "{(b,d)}",        "{(b,c),(c,d)}",  "{(b,c),(c,d)}",  },
        { __LINE__,  {"b","d","()"},  {"d"},           lt,  false,  false,  true,   "(b,d]",  "{}",     "{(b,d]}",        "{(b,d)}",        "{(b,d]}",        },
        { __LINE__,  {"b","d","()"},  {"e"},           lt,  false,  false,  false,  "(b,e]",  "{}",     "{(b,d),e}",      "{(b,d)}",        "{(b,d),e}",      },
        { __LINE__,  {"b","d","()"},  {"a","a","<"},   gt,  false,  false,  false,  "<d",     "{}",     "{<a,(b,d)}",     "{(b,d)}",        "{<a,(b,d)}",     },
        { __LINE__,  {"b","d","()"},  {"b","b","<"},   gt,  false,  false,  false,  "<d",     "{}",     "{<b,(b,d)}",     "{(b,d)}",        "{<b,(b,d)}",     },
        { __LINE__,  {"b","d","()"},  {"c","c","<"},   gt,  false,  true,   true,   "<d",     "(b,c)",  "{<d}",           "{[c,d)}",        "{<=b,[c,d)}",    },
        { __LINE__,  {"b","d","()"},  {"d","d","<"},   gt,  false,  true,   true,   "<d",     "(b,d)",  "{<d}",           "{}",             "{<=b}",          },
        { __LINE__,  {"b","d","()"},  {"e","e","<"},   gt,  false,  true,   true,   "<e",     "(b,d)",  "{<e}",           "{}",             "{<=b,[d,e)}",    },
        { __LINE__,  {"b","d","()"},  {"a","a","<="},  gt,  false,  false,  false,  "<d",     "{}",     "{<=a,(b,d)}",    "{(b,d)}",        "{<=a,(b,d)}",    },
        { __LINE__,  {"b","d","()"},  {"b","b","<="},  gt,  false,  false,  true,   "<d",     "{}",     "{<d}",           "{(b,d)}",        "{<d}",           },
        { __LINE__,  {"b","d","()"},  {"c","c","<="},  gt,  false,  true,   true,   "<d",     "(b,c]",  "{<d}",           "{(c,d)}",        "{<=b,(c,d)}",    },
        { __LINE__,  {"b","d","()"},  {"d","d","<="},  gt,  false,  true,   true,   "<=d",    "(b,d)",  "{<=d}",          "{}",             "{<=b,d}",        },
        { __LINE__,  {"b","d","()"},  {"e","e","<="},  gt,  false,  true,   true,   "<=e",    "(b,d)",  "{<=e}",          "{}",             "{<=b,[d,e]}",    },
        { __LINE__,  {"b","d","()"},  {"a","a",">"},   gt,  false,  true,   true,   ">a",     "(b,d)",  "{>a}",           "{}",             "{(a,b],>=d}",    },
        { __LINE__,  {"b","d","()"},  {"b","b",">"},   lt,  false,  true,   true,   ">b",     "(b,d)",  "{>b}",           "{}",             "{>=d}",          },
        { __LINE__,  {"b","d","()"},  {"c","c",">"},   lt,  false,  true,   true,   ">b",     "(c,d)",  "{>b}",           "{(b,c]}",        "{(b,c],>=d}",    },
        { __LINE__,  {"b","d","()"},  {"d","d",">"},   lt,  false,  false,  false,  ">b",     "{}",     "{(b,d),>d}",     "{(b,d)}",        "{(b,d),>d}",     },
        { __LINE__,  {"b","d","()"},  {"e","e",">"},   lt,  false,  false,  false,  ">b",     "{}",     "{(b,d),>e}",     "{(b,d)}",        "{(b,d),>e}",     },
        { __LINE__,  {"b","d","()"},  {"a","a",">="},  gt,  false,  true,   true,   ">=a",    "(b,d)",  "{>=a}",          "{}",             "{[a,b],>=d}",    },
        { __LINE__,  {"b","d","()"},  {"b","b",">="},  gt,  false,  true,   true,   ">=b",    "(b,d)",  "{>=b}",          "{}",             "{b,>=d}",        },
        { __LINE__,  {"b","d","()"},  {"c","c",">="},  lt,  false,  true,   true,   ">b",     "[c,d)",  "{>b}",           "{(b,c)}",        "{(b,c),>=d}",    },
        { __LINE__,  {"b","d","()"},  {"d","d",">="},  lt,  false,  false,  true,   ">b",     "{}",     "{>b}",           "{(b,d)}",        "{>b}",           },
        { __LINE__,  {"b","d","()"},  {"e","e",">="},  lt,  false,  false,  false,  ">b",     "{}",     "{(b,d),>=e}",    "{(b,d)}",        "{(b,d),>=e}",    },
        { __LINE__,  {"b","d","()"},  {"a","b","()"},  gt,  false,  false,  false,  "(a,d)",  "{}",     "{(a,b),(b,d)}",  "{(b,d)}",        "{(a,b),(b,d)}",  },
        { __LINE__,  {"b","d","()"},  {"a","c","()"},  gt,  false,  true,   true,   "(a,d)",  "(b,c)",  "{(a,d)}",        "{[c,d)}",        "{(a,b],[c,d)}",  },
        { __LINE__,  {"b","d","()"},  {"a","d","()"},  gt,  false,  true,   true,   "(a,d)",  "(b,d)",  "{(a,d)}",        "{}",             "{(a,b]}",        },
        { __LINE__,  {"b","d","()"},  {"a","e","()"},  gt,  false,  true,   true,   "(a,e)",  "(b,d)",  "{(a,e)}",        "{}",             "{(a,b],[d,e)}",  },
        { __LINE__,  {"b","d","()"},  {"b","c","()"},  gt,  true,   true,   true,   "(b,d)",  "(b,c)",  "{(b,d)}",        "{[c,d)}",        "{[c,d)}",        },
        { __LINE__,  {"b","d","()"},  {"b","d","()"},  eq,  true,   true,   true,   "(b,d)",  "(b,d)",  "{(b,d)}",        "{}",             "{}",             },
        { __LINE__,  {"b","d","()"},  {"b","e","()"},  lt,  false,  true,   true,   "(b,e)",  "(b,d)",  "{(b,e)}",        "{}",             "{[d,e)}",        },
        { __LINE__,  {"b","d","()"},  {"c","d","()"},  lt,  true,   true,   true,   "(b,d)",  "(c,d)",  "{(b,d)}",        "{(b,c]}",        "{(b,c]}",        },
        { __LINE__,  {"b","d","()"},  {"c","e","()"},  lt,  false,  true,   true,   "(b,e)",  "(c,d)",  "{(b,e)}",        "{(b,c]}",        "{(b,c],[d,e)}",  },
        { __LINE__,  {"b","d","()"},  {"d","e","()"},  lt,  false,  false,  false,  "(b,e)",  "{}",     "{(b,d),(d,e)}",  "{(b,d)}",        "{(b,d),(d,e)}",  },
        { __LINE__,  {"b","d","[)"},  {},              gt,  false,  false,  false,  "[b,d)",  "{}",     "{[b,d)}",        "{[b,d)}",        "{[b,d)}",        },
        { __LINE__,  {"b","d","[)"},  {" "," ","*"},   gt,  false,  true,   true,   "*",      "[b,d)",  "{*}",            "{}",             "{<b,>=d}",       },
        { __LINE__,  {"b","d","[)"},  {"a"},           gt,  false,  false,  false,  "[a,d)",  "{}",     "{a,[b,d)}",      "{[b,d)}",        "{a,[b,d)}",      },
        { __LINE__,  {"b","d","[)"},  {"b"},           gt,  true,   true,   true,   "[b,d)",  "b",      "{[b,d)}",        "{(b,d)}",        "{(b,d)}",        },
        { __LINE__,  {"b","d","[)"},  {"c"},           lt,  true,   true,   true,   "[b,d)",  "c",      "{[b,d)}",        "{[b,c),(c,d)}",  "{[b,c),(c,d)}",  },
        { __LINE__,  {"b","d","[)"},  {"d"},           lt,  false,  false,  true,   "[b,d]",  "{}",     "{[b,d]}",        "{[b,d)}",        "{[b,d]}",        },
        { __LINE__,  {"b","d","[)"},  {"e"},           lt,  false,  false,  false,  "[b,e]",  "{}",     "{[b,d),e}",      "{[b,d)}",        "{[b,d),e}",      },
        { __LINE__,  {"b","d","[)"},  {"a","a","<"},   gt,  false,  false,  false,  "<d",     "{}",     "{<a,[b,d)}",     "{[b,d)}",        "{<a,[b,d)}",     },
        ...
        { __LINE__,  {"b","d","[)"},  {"e","e","<"},   gt,  false,  true,   true,   "<e",     "[b,d)",  "{<e}",           "{}",             "{<b,[d,e)}",     },
        { __LINE__,  {"b","d","[)"},  {"a","a","<="},  gt,  false,  false,  false,  "<d",     "{}",     "{<=a,[b,d)}",    "{[b,d)}",        "{<=a,[b,d)}",    },
        { __LINE__,  {"b","d","[)"},  {"b","b","<="},  gt,  false,  true,   true,   "<d",     "b",      "{<d}",           "{(b,d)}",        "{<b,(b,d)}",     },
        { __LINE__,  {"b","d","[)"},  {"c","c","<="},  gt,  false,  true,   true,   "<d",     "[b,c]",  "{<d}",           "{(c,d)}",        "{<b,(c,d)}",     },
        { __LINE__,  {"b","d","[)"},  {"d","d","<="},  gt,  false,  true,   true,   "<=d",    "[b,d)",  "{<=d}",          "{}",             "{<b,d}",         },
        { __LINE__,  {"b","d","[)"},  {"e","e","<="},  gt,  false,  true,   true,   "<=e",    "[b,d)",  "{<=e}",          "{}",             "{<b,[d,e]}",     },
        { __LINE__,  {"b","d","[)"},  {"a","a",">"},   gt,  false,  true,   true,   ">a",     "[b,d)",  "{>a}",           "{}",             "{(a,b),>=d}",    },
        { __LINE__,  {"b","d","[)"},  {"b","b",">"},   lt,  false,  true,   true,   ">=b",    "(b,d)",  "{>=b}",          "{b}",            "{b,>=d}",        },
        { __LINE__,  {"b","d","[)"},  {"c","c",">"},   lt,  false,  true,   true,   ">=b",    "(c,d)",  "{>=b}",          "{[b,c]}",        "{[b,c],>=d}",    },
        { __LINE__,  {"b","d","[)"},  {"d","d",">"},   lt,  false,  false,  false,  ">=b",    "{}",     "{[b,d),>d}",     "{[b,d)}",        "{[b,d),>d}",     },
        { __LINE__,  {"b","d","[)"},  {"e","e",">"},   lt,  false,  false,  false,  ">=b",    "{}",     "{[b,d),>e}",     "{[b,d)}",        "{[b,d),>e}",     },
        { __LINE__,  {"b","d","[)"},  {"a","a",">="},  gt,  false,  true,   true,   ">=a",    "[b,d)",  "{>=a}",          "{}",             "{[a,b),>=d}",    },
        ...
        { __LINE__,  {"b","d","[)"},  {"d","d",">="},  lt,  false,  false,  true,   ">=b",    "{}",     "{>=b}",          "{[b,d)}",        "{>=b}",          },
        { __LINE__,  {"b","d","[)"},  {"e","e",">="},  lt,  false,  false,  false,  ">=b",    "{}",     "{[b,d),>=e}",    "{[b,d)}",        "{[b,d),>=e}",    },
        { __LINE__,  {"b","d","[)"},  {"a","b","()"},  gt,  false,  false,  true,   "(a,d)",  "{}",     "{(a,d)}",        "{[b,d)}",        "{(a,d)}",        },
        { __LINE__,  {"b","d","[)"},  {"a","c","()"},  gt,  false,  true,   true,   "(a,d)",  "[b,c)",  "{(a,d)}",        "{[c,d)}",        "{(a,b),[c,d)}",  },
        { __LINE__,  {"b","d","[)"},  {"a","d","()"},  gt,  false,  true,   true,   "(a,d)",  "[b,d)",  "{(a,d)}",        "{}",             "{(a,b)}",        },
        { __LINE__,  {"b","d","[)"},  {"a","e","()"},  gt,  false,  true,   true,   "(a,e)",  "[b,d)",  "{(a,e)}",        "{}",             "{(a,b),[d,e)}",  },
        { __LINE__,  {"b","d","[)"},  {"b","c","()"},  lt,  true,   true,   true,   "[b,d)",  "(b,c)",  "{[b,d)}",        "{b,[c,d)}",      "{b,[c,d)}",      },
        { __LINE__,  {"b","d","[)"},  {"b","d","()"},  lt,  true,   true,   true,   "[b,d)",  "(b,d)",  "{[b,d)}",        "{b}",            "{b}",            },
        { __LINE__,  {"b","d","[)"},  {"b","e","()"},  lt,  false,  true,   true,   "[b,e)",  "(b,d)",  "{[b,e)}",        "{b}",            "{b,[d,e)}",      },
        { __LINE__,  {"b","d","[)"},  {"c","d","()"},  lt,  true,   true,   true,   "[b,d)",  "(c,d)",  "{[b,d)}",        "{[b,c]}",        "{[b,c]}",        },
        { __LINE__,  {"b","d","[)"},  {"c","e","()"},  lt,  false,  true,   true,   "[b,e)",  "(c,d)",  "{[b,e)}",        "{[b,c]}",        "{[b,c],[d,e)}",  },
        { __LINE__,  {"b","d","[)"},  {"d","e","()"},  lt,  false,  false,  false,  "[b,e)",  "{}",     "{[b,d),(d,e)}",  "{[b,d)}",        "{[b,d),(d,e)}",  },
        { __LINE__,  {"b","d","[)"},  {"a","b","[)"},  gt,  false,  false,  true,   "[a,d)",  "{}",     "{[a,d)}",        "{[b,d)}",        "{[a,d)}",        },
        ...
        { __LINE__,  {"b","d","[)"},  {"c","d","[)"},  lt,  true,   true,   true,   "[b,d)",  "[c,d)",  "{[b,d)}",        "{[b,c)}",        "{[b,c)}",        },
        { __LINE__,  {"b","d","[)"},  {"c","e","[)"},  lt,  false,  true,   true,   "[b,e)",  "[c,d)",  "{[b,e)}",        "{[b,c)}",        "{[b,c),[d,e)}",  },
        { __LINE__,  {"b","d","[)"},  {"d","e","[)"},  lt,  false,  false,  true,   "[b,e)",  "{}",     "{[b,e)}",        "{[b,d)}",        "{[b,e)}",        },
        { __LINE__,  {"b","d","(]"},  {},              gt,  false,  false,  false,  "(b,d]",  "{}",     "{(b,d]}",        "{(b,d]}",        "{(b,d]}",        },
        { __LINE__,  {"b","d","(]"},  {" "," ","*"},   gt,  false,  true,   true,   "*",      "(b,d]",  "{*}",            "{}",             "{<=b,>d}",       },
        { __LINE__,  {"b","d","(]"},  {"a"},           gt,  false,  false,  false,  "[a,d]",  "{}",     "{a,(b,d]}",      "{(b,d]}",        "{a,(b,d]}",      },
        { __LINE__,  {"b","d","(]"},  {"b"},           gt,  false,  false,  true,   "[b,d]",  "{}",     "{[b,d]}",        "{(b,d]}",        "{[b,d]}",        },
        { __LINE__,  {"b","d","(]"},  {"c"},           lt,  true,   true,   true,   "(b,d]",  "c",      "{(b,d]}",        "{(b,c),(c,d]}",  "{(b,c),(c,d]}",  },
        { __LINE__,  {"b","d","(]"},  {"d"},           lt,  true,   true,   true,   "(b,d]",  "d",      "{(b,d]}",        "{(b,d)}",        "{(b,d)}",        },
        { __LINE__,  {"b","d","(]"},  {"e"},           lt,  false,  false,  false,  "(b,e]",  "{}",     "{(b,d],e}",      "{(b,d]}",        "{(b,d],e}",      },
        { __LINE__,  {"b","d","(]"},  {"a","a","<"},   gt,  false,  false,  false,  "<=d",    "{}",     "{<a,(b,d]}",     "{(b,d]}",        "{<a,(b,d]}",     },
        { __LINE__,  {"b","d","(]"},  {"b","b","<"},   gt,  false,  false,  false,  "<=d",    "{}",     "{<b,(b,d]}",     "{(b,d]}",        "{<b,(b,d]}",     },
        { __LINE__,  {"b","d","(]"},  {"c","c","<"},   gt,  false,  true,   true,   "<=d",    "(b,c)",  "{<=d}",          "{[c,d]}",        "{<=b,[c,d]}",    },
        { __LINE__,  {"b","d","(]"},  {"d","d","<"},   gt,  false,  true,   true,   "<=d",    "(b,d)",  "{<=d}",          "{d}",            "{<=b,d}",        },
        { __LINE__,  {"b","d","(]"},  {"e","e","<"},   gt,  false,  true,   true,   "<e",     "(b,d]",  "{<e}",           "{}",             "{<=b,(d,e)}",    },
        { __LINE__,  {"b","d","(]"},  {"a","a","<="},  gt,  false,  false,  false,  "<=d",    "{}",     "{<=a,(b,d]}",    "{(b,d]}",        "{<=a,(b,d]}",    },
        { __LINE__,  {"b","d","(]"},  {"b","b","<="},  gt,  false,  false,  true,   "<=d",    "{}",     "{<=d}",          "{(b,d]}",        "{<=d}",          },
        { __LINE__,  {"b","d","(]"},  {"c","c","<="},  gt,  false,  true,   true,   "<=d",    "(b,c]",  "{<=d}",          "{(c,d]}",        "{<=b,(c,d]}",    },
        ...
        { __LINE__,  {"b","d","(]"},  {"b","b",">="},  gt,  false,  true,   true,   ">=b",    "(b,d]",  "{>=b}",          "{}",             "{b,>d}",         },
        { __LINE__,  {"b","d","(]"},  {"c","c",">="},  lt,  false,  true,   true,   ">b",     "[c,d]",  "{>b}",           "{(b,c)}",        "{(b,c),>d}",     },
        { __LINE__,  {"b","d","(]"},  {"d","d",">="},  lt,  false,  true,   true,   ">b",     "d",      "{>b}",           "{(b,d)}",        "{(b,d),>d}",     },
        { __LINE__,  {"b","d","(]"},  {"e","e",">="},  lt,  false,  false,  false,  ">b",     "{}",     "{(b,d],>=e}",    "{(b,d]}",        "{(b,d],>=e}",    },
        { __LINE__,  {"b","d","(]"},  {"a","b","()"},  gt,  false,  false,  false,  "(a,d]",  "{}",     "{(a,b),(b,d]}",  "{(b,d]}",        "{(a,b),(b,d]}",  },
        { __LINE__,  {"b","d","(]"},  {"a","c","()"},  gt,  false,  true,   true,   "(a,d]",  "(b,c)",  "{(a,d]}",        "{[c,d]}",        "{(a,b],[c,d]}",  },
        { __LINE__,  {"b","d","(]"},  {"a","d","()"},  gt,  false,  true,   true,   "(a,d]",  "(b,d)",  "{(a,d]}",        "{d}",            "{(a,b],d}",      },
        { __LINE__,  {"b","d","(]"},  {"a","e","()"},  gt,  false,  true,   true,   "(a,e)",  "(b,d]",  "{(a,e)}",        "{}",             "{(a,b],(d,e)}",  },
        { __LINE__,  {"b","d","(]"},  {"b","c","()"},  gt,  true,   true,   true,   "(b,d]",  "(b,c)",  "{(b,d]}",        "{[c,d]}",        "{[c,d]}",        },
        { __LINE__,  {"b","d","(]"},  {"b","d","()"},  gt,  true,   true,   true,   "(b,d]",  "(b,d)",  "{(b,d]}",        "{d}",            "{d}",            },
        { __LINE__,  {"b","d","(]"},  {"b","e","()"},  lt,  false,  true,   true,   "(b,e)",  "(b,d]",  "{(b,e)}",        "{}",             "{(d,e)}",        },
        { __LINE__,  {"b","d","(]"},  {"c","d","()"},  lt,  true,   true,   true,   "(b,d]",  "(c,d)",  "{(b,d]}",        "{(b,c],d}",      "{(b,c],d}",      },
        { __LINE__,  {"b","d","(]"},  {"c","e","()"},  lt,  false,  true,   true,   "(b,e)",  "(c,d]",  "{(b,e)}",        "{(b,c]}",        "{(b,c],(d,e)}",  },
        { __LINE__,  {"b","d","(]"},  {"d","e","()"},  lt,  false,  false,  true,   "(b,e)",  "{}",     "{(b,e)}",        "{(b,d]}",        "{(b,e)}",        },
        { __LINE__,  {"b","d","(]"},  {"a","b","[)"},  gt,  false,  false,  false,  "[a,d]",  "{}",     "{[a,b),(b,d]}",  "{(b,d]}",        "{[a,b),(b,d]}",  },
        { __LINE__,  {"b","d","(]"},  {"a","c","[)"},  gt,  false,  true,   true,   "[a,d]",  "(b,c)",  "{[a,d]}",        "{[c,d]}",        "{[a,b],[c,d]}",  },
        { __LINE__,  {"b","d","(]"},  {"a","d","[)"},  gt,  false,  true,   true,   "[a,d]",  "(b,d)",  "{[a,d]}",        "{d}",            "{[a,b],d}",      },
        { __LINE__,  {"b","d","(]"},  {"a","e","[)"},  gt,  false,  true,   true,   "[a,e)",  "(b,d]",  "{[a,e)}",        "{}",             "{[a,b],(d,e)}",  },
        { __LINE__,  {"b","d","(]"},  {"b","c","[)"},  gt,  false,  true,   true,   "[b,d]",  "(b,c)",  "{[b,d]}",        "{[c,d]}",        "{b,[c,d]}",      },
        { __LINE__,  {"b","d","(]"},  {"b","d","[)"},  gt,  false,  true,   true,   "[b,d]",  "(b,d)",  "{[b,d]}",        "{d}",            "{b,d}",          },
        { __LINE__,  {"b","d","(]"},  {"b","e","[)"},  gt,  false,  true,   true,   "[b,e)",  "(b,d]",  "{[b,e)}",        "{}",             "{b,(d,e)}",      },
        { __LINE__,  {"b","d","(]"},  {"c","d","[)"},  lt,  true,   true,   true,   "(b,d]",  "[c,d)",  "{(b,d]}",        "{(b,c),d}",      "{(b,c),d}",      },
        { __LINE__,  {"b","d","(]"},  {"c","e","[)"},  lt,  false,  true,   true,   "(b,e)",  "[c,d]",  "{(b,e)}",        "{(b,c)}",        "{(b,c),(d,e)}",  },
        { __LINE__,  {"b","d","(]"},  {"d","e","[)"},  lt,  false,  true,   true,   "(b,e)",  "d",      "{(b,e)}",        "{(b,d)}",        "{(b,d),(d,e)}",  },
        { __LINE__,  {"b","d","(]"},  {"a","b","(]"},  gt,  false,  false,  true,   "(a,d]",  "{}",     "{(a,d]}",        "{(b,d]}",        "{(a,d]}",        },
        { __LINE__,  {"b","d","(]"},  {"a","c","(]"},  gt,  false,  true,   true,   "(a,d]",  "(b,c]",  "{(a,d]}",        "{(c,d]}",        "{(a,b],(c,d]}",  },
        { __LINE__,  {"b","d","(]"},  {"a","d","(]"},  gt,  false,  true,   true,   "(a,d]",  "(b,d]",  "{(a,d]}",        "{}",             "{(a,b]}",        },
        { __LINE__,  {"b","d","(]"},  {"a","e","(]"},  gt,  false,  true,   true,   "(a,e]",  "(b,d]",  "{(a,e]}",        "{}",             "{(a,b],(d,e]}",  },
        ...
        { __LINE__,  {"b","d","[]"},  {"a","e","()"},  gt,  false,  true,   true,   "(a,e)",  "[b,d]",  "{(a,e)}",        "{}",             "{(a,b),(d,e)}",  },
        { __LINE__,  {"b","d","[]"},  {"b","c","()"},  lt,  true,   true,   true,   "[b,d]",  "(b,c)",  "{[b,d]}",        "{b,[c,d]}",      "{b,[c,d]}",      },
        { __LINE__,  {"b","d","[]"},  {"b","d","()"},  lt,  true,   true,   true,   "[b,d]",  "(b,d)",  "{[b,d]}",        "{b,d}",          "{b,d}",          },
        { __LINE__,  {"b","d","[]"},  {"b","e","()"},  lt,  false,  true,   true,   "[b,e)",  "(b,d]",  "{[b,e)}",        "{b}",            "{b,(d,e)}",      },
        { __LINE__,  {"b","d","[]"},  {"c","d","()"},  lt,  true,   true,   true,   "[b,d]",  "(c,d)",  "{[b,d]}",        "{[b,c],d}",      "{[b,c],d}",      },
        { __LINE__,  {"b","d","[]"},  {"c","e","()"},  lt,  false,  true,   true,   "[b,e)",  "(c,d]",  "{[b,e)}",        "{[b,c]}",        "{[b,c],(d,e)}",  },
        { __LINE__,  {"b","d","[]"},  {"d","e","()"},  lt,  false,  false,  true,   "[b,e)",  "{}",     "{[b,e)}",        "{[b,d]}",        "{[b,e)}",        },
        ...
        { __LINE__,  {"b","d","[]"},  {"c","e","[)"},  lt,  false,  true,   true,   "[b,e)",  "[c,d]",  "{[b,e)}",        "{[b,c)}",        "{[b,c),(d,e)}",  },
        { __LINE__,  {"b","d","[]"},  {"d","e","[)"},  lt,  false,  true,   true,   "[b,e)",  "d",      "{[b,e)}",        "{[b,d)}",        "{[b,d),(d,e)}",  },
        { __LINE__,  {"b","d","[]"},  {"a","b","(]"},  gt,  false,  true,   true,   "(a,d]",  "b",      "{(a,d]}",        "{(b,d]}",        "{(a,b),(b,d]}",  },
        { __LINE__,  {"b","d","[]"},  {"a","c","(]"},  gt,  false,  true,   true,   "(a,d]",  "[b,c]",  "{(a,d]}",        "{(c,d]}",        "{(a,b),(c,d]}",  },
        { __LINE__,  {"b","d","[]"},  {"a","d","(]"},  gt,  false,  true,   true,   "(a,d]",  "[b,d]",  "{(a,d]}",        "{}",             "{(a,b)}",        },
        { __LINE__,  {"b","d","[]"},  {"a","e","(]"},  gt,  false,  true,   true,   "(a,e]",  "[b,d]",  "{(a,e]}",        "{}",             "{(a,b),(d,e]}",  },
        { __LINE__,  {"b","d","[]"},  {"b","c","(]"},  lt,  true,   true,   true,   "[b,d]",  "(b,c]",  "{[b,d]}",        "{b,(c,d]}",      "{b,(c,d]}",      },
        ...
        { __LINE__,  {"b","d","[]"},  {"c","e","(]"},  lt,  false,  true,   true,   "[b,e]",  "(c,d]",  "{[b,e]}",        "{[b,c]}",        "{[b,c],(d,e]}",  },
        { __LINE__,  {"b","d","[]"},  {"d","e","(]"},  lt,  false,  false,  true,   "[b,e]",  "{}",     "{[b,e]}",        "{[b,d]}",        "{[b,e]}",        },
        { __LINE__,  {"b","d","[]"},  {"a","a","[]"},  gt,  false,  false,  false,  "[a,d]",  "{}",     "{a,[b,d]}",      "{[b,d]}",        "{a,[b,d]}",      },
        { __LINE__,  {"b","d","[]"},  {"a","b","[]"},  gt,  false,  true,   true,   "[a,d]",  "b",      "{[a,d]}",        "{(b,d]}",        "{[a,b),(b,d]}",  },
        { __LINE__,  {"b","d","[]"},  {"a","c","[]"},  gt,  false,  true,   true,   "[a,d]",  "[b,c]",  "{[a,d]}",        "{(c,d]}",        "{[a,b),(c,d]}",  },
        { __LINE__,  {"b","d","[]"},  {"a","d","[]"},  gt,  false,  true,   true,   "[a,d]",  "[b,d]",  "{[a,d]}",        "{}",             "{[a,b)}",        },
        { __LINE__,  {"b","d","[]"},  {"a","e","[]"},  gt,  false,  true,   true,   "[a,e]",  "[b,d]",  "{[a,e]}",        "{}",             "{[a,b),(d,e]}",  },
...
void test_crow_interval_ordered_interval_hashing() {
