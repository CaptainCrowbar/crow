...
void test_crow_interval_continuous_contains_zero() {
...
void test_crow_interval_continuous_interval_reciprocal() {
    ...
    TRY(in = Itv());            TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 0u);  TRY(str = rec.str());  TEST_EQUAL(str, "{}");
    TRY(in = Itv::all());       TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 2u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<0,>0}");
    TRY(in = Itv(-2));          TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{-0.5}");
    TRY(in = Itv(0));           TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 0u);  TRY(str = rec.str());  TEST_EQUAL(str, "{}");
    TRY(in = Itv(2));           TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{0.5}");
    TRY(in = Itv(-2,-2,"<="));  TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{[-0.5,0)}");
    TRY(in = Itv(-2,-2,"<"));   TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{(-0.5,0)}");
    TRY(in = Itv(-2,-2,">="));  TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 2u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<=-0.5,>0}");
    TRY(in = Itv(-2,-2,">"));   TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 2u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<-0.5,>0}");
    TRY(in = Itv(0,0,"<="));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<0}");
    TRY(in = Itv(0,0,"<"));     TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<0}");
    TRY(in = Itv(0,0,">="));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{>0}");
    TRY(in = Itv(0,0,">"));     TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{>0}");
    TRY(in = Itv(2,2,"<="));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 2u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<0,>=0.5}");
    TRY(in = Itv(2,2,"<"));     TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 2u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<0,>0.5}");
    TRY(in = Itv(2,2,">="));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{(0,0.5]}");
    TRY(in = Itv(2,2,">"));     TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{(0,0.5)}");
    TRY(in = Itv(-4,-2,"[]"));  TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{[-0.5,-0.25]}");
    TRY(in = Itv(-4,-2,"()"));  TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{(-0.5,-0.25)}");
    TRY(in = Itv(-4,-2,"[)"));  TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{(-0.5,-0.25]}");
    TRY(in = Itv(-4,-2,"(]"));  TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{[-0.5,-0.25)}");
    TRY(in = Itv(-2,0,"[]"));   TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<=-0.5}");
    TRY(in = Itv(-2,0,"()"));   TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<-0.5}");
    TRY(in = Itv(-2,0,"[)"));   TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<=-0.5}");
    TRY(in = Itv(-2,0,"(]"));   TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<-0.5}");
    TRY(in = Itv(-2,2,"[]"));   TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 2u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<=-0.5,>=0.5}");
    TRY(in = Itv(-2,2,"()"));   TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 2u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<-0.5,>0.5}");
    TRY(in = Itv(-2,2,"[)"));   TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 2u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<=-0.5,>0.5}");
    TRY(in = Itv(-2,2,"(]"));   TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 2u);  TRY(str = rec.str());  TEST_EQUAL(str, "{<-0.5,>=0.5}");
    TRY(in = Itv(0,2,"[]"));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{>=0.5}");
    TRY(in = Itv(0,2,"()"));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{>0.5}");
    TRY(in = Itv(0,2,"[)"));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{>0.5}");
    TRY(in = Itv(0,2,"(]"));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{>=0.5}");
    TRY(in = Itv(2,4,"[]"));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{[0.25,0.5]}");
    TRY(in = Itv(2,4,"()"));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{(0.25,0.5)}");
    TRY(in = Itv(2,4,"[)"));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{(0.25,0.5]}");
    TRY(in = Itv(2,4,"(]"));    TRY(rec = reciprocal_set(in));  TEST_EQUAL(rec.size(), 1u);  TRY(str = rec.str());  TEST_EQUAL(str, "{[0.25,0.5)}");
...
void test_crow_interval_continuous_interval_arithmetic() {
