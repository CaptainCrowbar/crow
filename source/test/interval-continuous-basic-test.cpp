...
void test_crow_interval_continuous_interval_binary_operations() {
    ...
    static const std::vector<test_info> tests = {
        ...
        { __LINE__,  {2},         {},          gt,  false,  false,  false,  "2",      "{}",     "{2}",            "{2}",            "{2}",            },
        { __LINE__,  {2},         {0,0,"*"},   gt,  false,  true,   true,   "*",      "2",      "{*}",            "{}",             "{<2,>2}",        },
        { __LINE__,  {2},         {1},         gt,  false,  false,  false,  "[1,2]",  "{}",     "{1,2}",          "{2}",            "{1,2}",          },
        { __LINE__,  {2},         {2},         eq,  true,   true,   true,   "2",      "2",      "{2}",            "{}",             "{}",             },
        { __LINE__,  {2},         {3},         lt,  false,  false,  false,  "[2,3]",  "{}",     "{2,3}",          "{2}",            "{2,3}",          },
        { __LINE__,  {2,2,"<"},   {},          gt,  false,  false,  false,  "<2",     "{}",     "{<2}",           "{<2}",           "{<2}",           },
        { __LINE__,  {2,2,"<"},   {0,0,"*"},   lt,  false,  true,   true,   "*",      "<2",     "{*}",            "{}",             "{>=2}",          },
        { __LINE__,  {2,2,"<"},   {1},         lt,  true,   true,   true,   "<2",     "1",      "{<2}",           "{<1,(1,2)}",     "{<1,(1,2)}",     },
        { __LINE__,  {2,2,"<"},   {2},         lt,  false,  false,  true,   "<=2",    "{}",     "{<=2}",          "{<2}",           "{<=2}",          },
        { __LINE__,  {2,2,"<"},   {3},         lt,  false,  false,  false,  "<=3",    "{}",     "{<2,3}",         "{<2}",           "{<2,3}",         },
        { __LINE__,  {2,2,"<"},   {1,1,"<"},   gt,  true,   true,   true,   "<2",     "<1",     "{<2}",           "{[1,2)}",        "{[1,2)}",        },
        { __LINE__,  {2,2,"<"},   {2,2,"<"},   eq,  true,   true,   true,   "<2",     "<2",     "{<2}",           "{}",             "{}",             },
        { __LINE__,  {2,2,"<"},   {3,3,"<"},   lt,  false,  true,   true,   "<3",     "<2",     "{<3}",           "{}",             "{[2,3)}",        },
        { __LINE__,  {2,2,"<="},  {},          gt,  false,  false,  false,  "<=2",    "{}",     "{<=2}",          "{<=2}",          "{<=2}",          },
        { __LINE__,  {2,2,"<="},  {0,0,"*"},   lt,  false,  true,   true,   "*",      "<=2",    "{*}",            "{}",             "{>2}",           },
        { __LINE__,  {2,2,"<="},  {1},         lt,  true,   true,   true,   "<=2",    "1",      "{<=2}",          "{<1,(1,2]}",     "{<1,(1,2]}",     },
        { __LINE__,  {2,2,"<="},  {2},         lt,  true,   true,   true,   "<=2",    "2",      "{<=2}",          "{<2}",           "{<2}",           },
        { __LINE__,  {2,2,"<="},  {3},         lt,  false,  false,  false,  "<=3",    "{}",     "{<=2,3}",        "{<=2}",          "{<=2,3}",        },
        { __LINE__,  {2,2,"<="},  {1,1,"<"},   gt,  true,   true,   true,   "<=2",    "<1",     "{<=2}",          "{[1,2]}",        "{[1,2]}",        },
        { __LINE__,  {2,2,"<="},  {2,2,"<"},   gt,  true,   true,   true,   "<=2",    "<2",     "{<=2}",          "{2}",            "{2}",            },
        { __LINE__,  {2,2,"<="},  {3,3,"<"},   lt,  false,  true,   true,   "<3",     "<=2",    "{<3}",           "{}",             "{(2,3)}",        },
        { __LINE__,  {2,2,"<="},  {1,1,"<="},  gt,  true,   true,   true,   "<=2",    "<=1",    "{<=2}",          "{(1,2]}",        "{(1,2]}",        },
        { __LINE__,  {2,2,"<="},  {2,2,"<="},  eq,  true,   true,   true,   "<=2",    "<=2",    "{<=2}",          "{}",             "{}",             },
        { __LINE__,  {2,2,"<="},  {3,3,"<="},  lt,  false,  true,   true,   "<=3",    "<=2",    "{<=3}",          "{}",             "{(2,3]}",        },
        { __LINE__,  {2,2,">"},   {},          gt,  false,  false,  false,  ">2",     "{}",     "{>2}",           "{>2}",           "{>2}",           },
        { __LINE__,  {2,2,">"},   {0,0,"*"},   gt,  false,  true,   true,   "*",      ">2",     "{*}",            "{}",             "{<=2}",          },
        { __LINE__,  {2,2,">"},   {1},         gt,  false,  false,  false,  ">=1",    "{}",     "{1,>2}",         "{>2}",           "{1,>2}",         },
        { __LINE__,  {2,2,">"},   {2},         gt,  false,  false,  true,   ">=2",    "{}",     "{>=2}",          "{>2}",           "{>=2}",          },
        { __LINE__,  {2,2,">"},   {3},         lt,  true,   true,   true,   ">2",     "3",      "{>2}",           "{(2,3),>3}",     "{(2,3),>3}",     },
        { __LINE__,  {2,2,">"},   {1,1,"<"},   gt,  false,  false,  false,  "*",      "{}",     "{<1,>2}",        "{>2}",           "{<1,>2}",        },
        { __LINE__,  {2,2,">"},   {2,2,"<"},   gt,  false,  false,  false,  "*",      "{}",     "{<2,>2}",        "{>2}",           "{<2,>2}",        },
        { __LINE__,  {2,2,">"},   {3,3,"<"},   gt,  false,  true,   true,   "*",      "(2,3)",  "{*}",            "{>=3}",          "{<=2,>=3}",      },
        { __LINE__,  {2,2,">"},   {1,1,"<="},  gt,  false,  false,  false,  "*",      "{}",     "{<=1,>2}",       "{>2}",           "{<=1,>2}",       },
        { __LINE__,  {2,2,">"},   {2,2,"<="},  gt,  false,  false,  true,   "*",      "{}",     "{*}",            "{>2}",           "{*}",            },
        { __LINE__,  {2,2,">"},   {3,3,"<="},  gt,  false,  true,   true,   "*",      "(2,3]",  "{*}",            "{>3}",           "{<=2,>3}",       },
        { __LINE__,  {2,2,">"},   {1,1,">"},   gt,  false,  true,   true,   ">1",     ">2",     "{>1}",           "{}",             "{(1,2]}",        },
        { __LINE__,  {2,2,">"},   {2,2,">"},   eq,  true,   true,   true,   ">2",     ">2",     "{>2}",           "{}",             "{}",             },
        { __LINE__,  {2,2,">"},   {3,3,">"},   lt,  true,   true,   true,   ">2",     ">3",     "{>2}",           "{(2,3]}",        "{(2,3]}",        },
        { __LINE__,  {2,2,">="},  {},          gt,  false,  false,  false,  ">=2",    "{}",     "{>=2}",          "{>=2}",          "{>=2}",          },
        { __LINE__,  {2,2,">="},  {0,0,"*"},   gt,  false,  true,   true,   "*",      ">=2",    "{*}",            "{}",             "{<2}",           },
        { __LINE__,  {2,2,">="},  {1},         gt,  false,  false,  false,  ">=1",    "{}",     "{1,>=2}",        "{>=2}",          "{1,>=2}",        },
        { __LINE__,  {2,2,">="},  {2},         gt,  true,   true,   true,   ">=2",    "2",      "{>=2}",          "{>2}",           "{>2}",           },
        { __LINE__,  {2,2,">="},  {3},         lt,  true,   true,   true,   ">=2",    "3",      "{>=2}",          "{[2,3),>3}",     "{[2,3),>3}",     },
        { __LINE__,  {2,2,">="},  {1,1,"<"},   gt,  false,  false,  false,  "*",      "{}",     "{<1,>=2}",       "{>=2}",          "{<1,>=2}",       },
        { __LINE__,  {2,2,">="},  {2,2,"<"},   gt,  false,  false,  true,   "*",      "{}",     "{*}",            "{>=2}",          "{*}",            },
        { __LINE__,  {2,2,">="},  {3,3,"<"},   gt,  false,  true,   true,   "*",      "[2,3)",  "{*}",            "{>=3}",          "{<2,>=3}",       },
        { __LINE__,  {2,2,">="},  {1,1,"<="},  gt,  false,  false,  false,  "*",      "{}",     "{<=1,>=2}",      "{>=2}",          "{<=1,>=2}",      },
        { __LINE__,  {2,2,">="},  {2,2,"<="},  gt,  false,  true,   true,   "*",      "2",      "{*}",            "{>2}",           "{<2,>2}",        },
        { __LINE__,  {2,2,">="},  {3,3,"<="},  gt,  false,  true,   true,   "*",      "[2,3]",  "{*}",            "{>3}",           "{<2,>3}",        },
        { __LINE__,  {2,2,">="},  {1,1,">"},   gt,  false,  true,   true,   ">1",     ">=2",    "{>1}",           "{}",             "{(1,2)}",        },
        { __LINE__,  {2,2,">="},  {2,2,">"},   lt,  true,   true,   true,   ">=2",    ">2",     "{>=2}",          "{2}",            "{2}",            },
        { __LINE__,  {2,2,">="},  {3,3,">"},   lt,  true,   true,   true,   ">=2",    ">3",     "{>=2}",          "{[2,3]}",        "{[2,3]}",        },
        { __LINE__,  {2,2,">="},  {1,1,">="},  gt,  false,  true,   true,   ">=1",    ">=2",    "{>=1}",          "{}",             "{[1,2)}",        },
        { __LINE__,  {2,2,">="},  {2,2,">="},  eq,  true,   true,   true,   ">=2",    ">=2",    "{>=2}",          "{}",             "{}",             },
        { __LINE__,  {2,2,">="},  {3,3,">="},  lt,  true,   true,   true,   ">=2",    ">=3",    "{>=2}",          "{[2,3)}",        "{[2,3)}",        },
        { __LINE__,  {2,4,"()"},  {},          gt,  false,  false,  false,  "(2,4)",  "{}",     "{(2,4)}",        "{(2,4)}",        "{(2,4)}",        },
        { __LINE__,  {2,4,"()"},  {0,0,"*"},   gt,  false,  true,   true,   "*",      "(2,4)",  "{*}",            "{}",             "{<=2,>=4}",      },
        { __LINE__,  {2,4,"()"},  {1},         gt,  false,  false,  false,  "[1,4)",  "{}",     "{1,(2,4)}",      "{(2,4)}",        "{1,(2,4)}",      },
        { __LINE__,  {2,4,"()"},  {2},         gt,  false,  false,  true,   "[2,4)",  "{}",     "{[2,4)}",        "{(2,4)}",        "{[2,4)}",        },
        { __LINE__,  {2,4,"()"},  {3},         lt,  true,   true,   true,   "(2,4)",  "3",      "{(2,4)}",        "{(2,3),(3,4)}",  "{(2,3),(3,4)}",  },
        { __LINE__,  {2,4,"()"},  {4},         lt,  false,  false,  true,   "(2,4]",  "{}",     "{(2,4]}",        "{(2,4)}",        "{(2,4]}",        },
        { __LINE__,  {2,4,"()"},  {5},         lt,  false,  false,  false,  "(2,5]",  "{}",     "{(2,4),5}",      "{(2,4)}",        "{(2,4),5}",      },
        { __LINE__,  {2,4,"()"},  {1,1,"<"},   gt,  false,  false,  false,  "<4",     "{}",     "{<1,(2,4)}",     "{(2,4)}",        "{<1,(2,4)}",     },
        { __LINE__,  {2,4,"()"},  {2,2,"<"},   gt,  false,  false,  false,  "<4",     "{}",     "{<2,(2,4)}",     "{(2,4)}",        "{<2,(2,4)}",     },
        { __LINE__,  {2,4,"()"},  {3,3,"<"},   gt,  false,  true,   true,   "<4",     "(2,3)",  "{<4}",           "{[3,4)}",        "{<=2,[3,4)}",    },
        { __LINE__,  {2,4,"()"},  {4,4,"<"},   gt,  false,  true,   true,   "<4",     "(2,4)",  "{<4}",           "{}",             "{<=2}",          },
        { __LINE__,  {2,4,"()"},  {5,5,"<"},   gt,  false,  true,   true,   "<5",     "(2,4)",  "{<5}",           "{}",             "{<=2,[4,5)}",    },
        { __LINE__,  {2,4,"()"},  {1,1,"<="},  gt,  false,  false,  false,  "<4",     "{}",     "{<=1,(2,4)}",    "{(2,4)}",        "{<=1,(2,4)}",    },
        { __LINE__,  {2,4,"()"},  {2,2,"<="},  gt,  false,  false,  true,   "<4",     "{}",     "{<4}",           "{(2,4)}",        "{<4}",           },
        { __LINE__,  {2,4,"()"},  {3,3,"<="},  gt,  false,  true,   true,   "<4",     "(2,3]",  "{<4}",           "{(3,4)}",        "{<=2,(3,4)}",    },
        { __LINE__,  {2,4,"()"},  {4,4,"<="},  gt,  false,  true,   true,   "<=4",    "(2,4)",  "{<=4}",          "{}",             "{<=2,4}",        },
        { __LINE__,  {2,4,"()"},  {5,5,"<="},  gt,  false,  true,   true,   "<=5",    "(2,4)",  "{<=5}",          "{}",             "{<=2,[4,5]}",    },
        { __LINE__,  {2,4,"()"},  {1,1,">"},   gt,  false,  true,   true,   ">1",     "(2,4)",  "{>1}",           "{}",             "{(1,2],>=4}",    },
        { __LINE__,  {2,4,"()"},  {2,2,">"},   lt,  false,  true,   true,   ">2",     "(2,4)",  "{>2}",           "{}",             "{>=4}",          },
        { __LINE__,  {2,4,"()"},  {3,3,">"},   lt,  false,  true,   true,   ">2",     "(3,4)",  "{>2}",           "{(2,3]}",        "{(2,3],>=4}",    },
        { __LINE__,  {2,4,"()"},  {4,4,">"},   lt,  false,  false,  false,  ">2",     "{}",     "{(2,4),>4}",     "{(2,4)}",        "{(2,4),>4}",     },
        { __LINE__,  {2,4,"()"},  {5,5,">"},   lt,  false,  false,  false,  ">2",     "{}",     "{(2,4),>5}",     "{(2,4)}",        "{(2,4),>5}",     },
        { __LINE__,  {2,4,"()"},  {1,1,">="},  gt,  false,  true,   true,   ">=1",    "(2,4)",  "{>=1}",          "{}",             "{[1,2],>=4}",    },
        { __LINE__,  {2,4,"()"},  {2,2,">="},  gt,  false,  true,   true,   ">=2",    "(2,4)",  "{>=2}",          "{}",             "{2,>=4}",        },
        { __LINE__,  {2,4,"()"},  {3,3,">="},  lt,  false,  true,   true,   ">2",     "[3,4)",  "{>2}",           "{(2,3)}",        "{(2,3),>=4}",    },
        { __LINE__,  {2,4,"()"},  {4,4,">="},  lt,  false,  false,  true,   ">2",     "{}",     "{>2}",           "{(2,4)}",        "{>2}",           },
        { __LINE__,  {2,4,"()"},  {5,5,">="},  lt,  false,  false,  false,  ">2",     "{}",     "{(2,4),>=5}",    "{(2,4)}",        "{(2,4),>=5}",    },
        { __LINE__,  {2,4,"()"},  {1,2,"()"},  gt,  false,  false,  false,  "(1,4)",  "{}",     "{(1,2),(2,4)}",  "{(2,4)}",        "{(1,2),(2,4)}",  },
        { __LINE__,  {2,4,"()"},  {1,3,"()"},  gt,  false,  true,   true,   "(1,4)",  "(2,3)",  "{(1,4)}",        "{[3,4)}",        "{(1,2],[3,4)}",  },
        { __LINE__,  {2,4,"()"},  {1,4,"()"},  gt,  false,  true,   true,   "(1,4)",  "(2,4)",  "{(1,4)}",        "{}",             "{(1,2]}",        },
        { __LINE__,  {2,4,"()"},  {1,5,"()"},  gt,  false,  true,   true,   "(1,5)",  "(2,4)",  "{(1,5)}",        "{}",             "{(1,2],[4,5)}",  },
        { __LINE__,  {2,4,"()"},  {2,3,"()"},  gt,  true,   true,   true,   "(2,4)",  "(2,3)",  "{(2,4)}",        "{[3,4)}",        "{[3,4)}",        },
        { __LINE__,  {2,4,"()"},  {2,4,"()"},  eq,  true,   true,   true,   "(2,4)",  "(2,4)",  "{(2,4)}",        "{}",             "{}",             },
        { __LINE__,  {2,4,"()"},  {2,5,"()"},  lt,  false,  true,   true,   "(2,5)",  "(2,4)",  "{(2,5)}",        "{}",             "{[4,5)}",        },
        { __LINE__,  {2,4,"()"},  {3,4,"()"},  lt,  true,   true,   true,   "(2,4)",  "(3,4)",  "{(2,4)}",        "{(2,3]}",        "{(2,3]}",        },
        { __LINE__,  {2,4,"()"},  {3,5,"()"},  lt,  false,  true,   true,   "(2,5)",  "(3,4)",  "{(2,5)}",        "{(2,3]}",        "{(2,3],[4,5)}",  },
        { __LINE__,  {2,4,"()"},  {4,5,"()"},  lt,  false,  false,  false,  "(2,5)",  "{}",     "{(2,4),(4,5)}",  "{(2,4)}",        "{(2,4),(4,5)}",  },
        { __LINE__,  {2,4,"[)"},  {},          gt,  false,  false,  false,  "[2,4)",  "{}",     "{[2,4)}",        "{[2,4)}",        "{[2,4)}",        },
        { __LINE__,  {2,4,"[)"},  {0,0,"*"},   gt,  false,  true,   true,   "*",      "[2,4)",  "{*}",            "{}",             "{<2,>=4}",       },
        { __LINE__,  {2,4,"[)"},  {1},         gt,  false,  false,  false,  "[1,4)",  "{}",     "{1,[2,4)}",      "{[2,4)}",        "{1,[2,4)}",      },
        { __LINE__,  {2,4,"[)"},  {2},         gt,  true,   true,   true,   "[2,4)",  "2",      "{[2,4)}",        "{(2,4)}",        "{(2,4)}",        },
        { __LINE__,  {2,4,"[)"},  {3},         lt,  true,   true,   true,   "[2,4)",  "3",      "{[2,4)}",        "{[2,3),(3,4)}",  "{[2,3),(3,4)}",  },
        { __LINE__,  {2,4,"[)"},  {4},         lt,  false,  false,  true,   "[2,4]",  "{}",     "{[2,4]}",        "{[2,4)}",        "{[2,4]}",        },
        { __LINE__,  {2,4,"[)"},  {5},         lt,  false,  false,  false,  "[2,5]",  "{}",     "{[2,4),5}",      "{[2,4)}",        "{[2,4),5}",      },
        { __LINE__,  {2,4,"[)"},  {1,1,"<"},   gt,  false,  false,  false,  "<4",     "{}",     "{<1,[2,4)}",     "{[2,4)}",        "{<1,[2,4)}",     },
        ...
        { __LINE__,  {2,4,"[)"},  {5,5,"<"},   gt,  false,  true,   true,   "<5",     "[2,4)",  "{<5}",           "{}",             "{<2,[4,5)}",     },
        { __LINE__,  {2,4,"[)"},  {1,1,"<="},  gt,  false,  false,  false,  "<4",     "{}",     "{<=1,[2,4)}",    "{[2,4)}",        "{<=1,[2,4)}",    },
        { __LINE__,  {2,4,"[)"},  {2,2,"<="},  gt,  false,  true,   true,   "<4",     "2",      "{<4}",           "{(2,4)}",        "{<2,(2,4)}",     },
        { __LINE__,  {2,4,"[)"},  {3,3,"<="},  gt,  false,  true,   true,   "<4",     "[2,3]",  "{<4}",           "{(3,4)}",        "{<2,(3,4)}",     },
        { __LINE__,  {2,4,"[)"},  {4,4,"<="},  gt,  false,  true,   true,   "<=4",    "[2,4)",  "{<=4}",          "{}",             "{<2,4}",         },
        { __LINE__,  {2,4,"[)"},  {5,5,"<="},  gt,  false,  true,   true,   "<=5",    "[2,4)",  "{<=5}",          "{}",             "{<2,[4,5]}",     },
        { __LINE__,  {2,4,"[)"},  {1,1,">"},   gt,  false,  true,   true,   ">1",     "[2,4)",  "{>1}",           "{}",             "{(1,2),>=4}",    },
        { __LINE__,  {2,4,"[)"},  {2,2,">"},   lt,  false,  true,   true,   ">=2",    "(2,4)",  "{>=2}",          "{2}",            "{2,>=4}",        },
        { __LINE__,  {2,4,"[)"},  {3,3,">"},   lt,  false,  true,   true,   ">=2",    "(3,4)",  "{>=2}",          "{[2,3]}",        "{[2,3],>=4}",    },
        { __LINE__,  {2,4,"[)"},  {4,4,">"},   lt,  false,  false,  false,  ">=2",    "{}",     "{[2,4),>4}",     "{[2,4)}",        "{[2,4),>4}",     },
        { __LINE__,  {2,4,"[)"},  {5,5,">"},   lt,  false,  false,  false,  ">=2",    "{}",     "{[2,4),>5}",     "{[2,4)}",        "{[2,4),>5}",     },
        { __LINE__,  {2,4,"[)"},  {1,1,">="},  gt,  false,  true,   true,   ">=1",    "[2,4)",  "{>=1}",          "{}",             "{[1,2),>=4}",    },
        ...
        { __LINE__,  {2,4,"[)"},  {4,4,">="},  lt,  false,  false,  true,   ">=2",    "{}",     "{>=2}",          "{[2,4)}",        "{>=2}",          },
        { __LINE__,  {2,4,"[)"},  {5,5,">="},  lt,  false,  false,  false,  ">=2",    "{}",     "{[2,4),>=5}",    "{[2,4)}",        "{[2,4),>=5}",    },
        { __LINE__,  {2,4,"[)"},  {1,2,"()"},  gt,  false,  false,  true,   "(1,4)",  "{}",     "{(1,4)}",        "{[2,4)}",        "{(1,4)}",        },
        { __LINE__,  {2,4,"[)"},  {1,3,"()"},  gt,  false,  true,   true,   "(1,4)",  "[2,3)",  "{(1,4)}",        "{[3,4)}",        "{(1,2),[3,4)}",  },
        { __LINE__,  {2,4,"[)"},  {1,4,"()"},  gt,  false,  true,   true,   "(1,4)",  "[2,4)",  "{(1,4)}",        "{}",             "{(1,2)}",        },
        { __LINE__,  {2,4,"[)"},  {1,5,"()"},  gt,  false,  true,   true,   "(1,5)",  "[2,4)",  "{(1,5)}",        "{}",             "{(1,2),[4,5)}",  },
        { __LINE__,  {2,4,"[)"},  {2,3,"()"},  lt,  true,   true,   true,   "[2,4)",  "(2,3)",  "{[2,4)}",        "{2,[3,4)}",      "{2,[3,4)}",      },
        { __LINE__,  {2,4,"[)"},  {2,4,"()"},  lt,  true,   true,   true,   "[2,4)",  "(2,4)",  "{[2,4)}",        "{2}",            "{2}",            },
        { __LINE__,  {2,4,"[)"},  {2,5,"()"},  lt,  false,  true,   true,   "[2,5)",  "(2,4)",  "{[2,5)}",        "{2}",            "{2,[4,5)}",      },
        { __LINE__,  {2,4,"[)"},  {3,4,"()"},  lt,  true,   true,   true,   "[2,4)",  "(3,4)",  "{[2,4)}",        "{[2,3]}",        "{[2,3]}",        },
        { __LINE__,  {2,4,"[)"},  {3,5,"()"},  lt,  false,  true,   true,   "[2,5)",  "(3,4)",  "{[2,5)}",        "{[2,3]}",        "{[2,3],[4,5)}",  },
        { __LINE__,  {2,4,"[)"},  {4,5,"()"},  lt,  false,  false,  false,  "[2,5)",  "{}",     "{[2,4),(4,5)}",  "{[2,4)}",        "{[2,4),(4,5)}",  },
        { __LINE__,  {2,4,"[)"},  {1,2,"[)"},  gt,  false,  false,  true,   "[1,4)",  "{}",     "{[1,4)}",        "{[2,4)}",        "{[1,4)}",        },
        ...
        { __LINE__,  {2,4,"[)"},  {3,4,"[)"},  lt,  true,   true,   true,   "[2,4)",  "[3,4)",  "{[2,4)}",        "{[2,3)}",        "{[2,3)}",        },
        { __LINE__,  {2,4,"[)"},  {3,5,"[)"},  lt,  false,  true,   true,   "[2,5)",  "[3,4)",  "{[2,5)}",        "{[2,3)}",        "{[2,3),[4,5)}",  },
        { __LINE__,  {2,4,"[)"},  {4,5,"[)"},  lt,  false,  false,  true,   "[2,5)",  "{}",     "{[2,5)}",        "{[2,4)}",        "{[2,5)}",        },
        { __LINE__,  {2,4,"(]"},  {},          gt,  false,  false,  false,  "(2,4]",  "{}",     "{(2,4]}",        "{(2,4]}",        "{(2,4]}",        },
        { __LINE__,  {2,4,"(]"},  {0,0,"*"},   gt,  false,  true,   true,   "*",      "(2,4]",  "{*}",            "{}",             "{<=2,>4}",       },
        { __LINE__,  {2,4,"(]"},  {1},         gt,  false,  false,  false,  "[1,4]",  "{}",     "{1,(2,4]}",      "{(2,4]}",        "{1,(2,4]}",      },
        { __LINE__,  {2,4,"(]"},  {2},         gt,  false,  false,  true,   "[2,4]",  "{}",     "{[2,4]}",        "{(2,4]}",        "{[2,4]}",        },
        { __LINE__,  {2,4,"(]"},  {3},         lt,  true,   true,   true,   "(2,4]",  "3",      "{(2,4]}",        "{(2,3),(3,4]}",  "{(2,3),(3,4]}",  },
        { __LINE__,  {2,4,"(]"},  {4},         lt,  true,   true,   true,   "(2,4]",  "4",      "{(2,4]}",        "{(2,4)}",        "{(2,4)}",        },
        { __LINE__,  {2,4,"(]"},  {5},         lt,  false,  false,  false,  "(2,5]",  "{}",     "{(2,4],5}",      "{(2,4]}",        "{(2,4],5}",      },
        { __LINE__,  {2,4,"(]"},  {1,1,"<"},   gt,  false,  false,  false,  "<=4",    "{}",     "{<1,(2,4]}",     "{(2,4]}",        "{<1,(2,4]}",     },
        { __LINE__,  {2,4,"(]"},  {2,2,"<"},   gt,  false,  false,  false,  "<=4",    "{}",     "{<2,(2,4]}",     "{(2,4]}",        "{<2,(2,4]}",     },
        { __LINE__,  {2,4,"(]"},  {3,3,"<"},   gt,  false,  true,   true,   "<=4",    "(2,3)",  "{<=4}",          "{[3,4]}",        "{<=2,[3,4]}",    },
        { __LINE__,  {2,4,"(]"},  {4,4,"<"},   gt,  false,  true,   true,   "<=4",    "(2,4)",  "{<=4}",          "{4}",            "{<=2,4}",        },
        { __LINE__,  {2,4,"(]"},  {5,5,"<"},   gt,  false,  true,   true,   "<5",     "(2,4]",  "{<5}",           "{}",             "{<=2,(4,5)}",    },
        { __LINE__,  {2,4,"(]"},  {1,1,"<="},  gt,  false,  false,  false,  "<=4",    "{}",     "{<=1,(2,4]}",    "{(2,4]}",        "{<=1,(2,4]}",    },
        { __LINE__,  {2,4,"(]"},  {2,2,"<="},  gt,  false,  false,  true,   "<=4",    "{}",     "{<=4}",          "{(2,4]}",        "{<=4}",          },
        { __LINE__,  {2,4,"(]"},  {3,3,"<="},  gt,  false,  true,   true,   "<=4",    "(2,3]",  "{<=4}",          "{(3,4]}",        "{<=2,(3,4]}",    },
        ...
        { __LINE__,  {2,4,"(]"},  {2,2,">="},  gt,  false,  true,   true,   ">=2",    "(2,4]",  "{>=2}",          "{}",             "{2,>4}",         },
        { __LINE__,  {2,4,"(]"},  {3,3,">="},  lt,  false,  true,   true,   ">2",     "[3,4]",  "{>2}",           "{(2,3)}",        "{(2,3),>4}",     },
        { __LINE__,  {2,4,"(]"},  {4,4,">="},  lt,  false,  true,   true,   ">2",     "4",      "{>2}",           "{(2,4)}",        "{(2,4),>4}",     },
        { __LINE__,  {2,4,"(]"},  {5,5,">="},  lt,  false,  false,  false,  ">2",     "{}",     "{(2,4],>=5}",    "{(2,4]}",        "{(2,4],>=5}",    },
        { __LINE__,  {2,4,"(]"},  {1,2,"()"},  gt,  false,  false,  false,  "(1,4]",  "{}",     "{(1,2),(2,4]}",  "{(2,4]}",        "{(1,2),(2,4]}",  },
        { __LINE__,  {2,4,"(]"},  {1,3,"()"},  gt,  false,  true,   true,   "(1,4]",  "(2,3)",  "{(1,4]}",        "{[3,4]}",        "{(1,2],[3,4]}",  },
        { __LINE__,  {2,4,"(]"},  {1,4,"()"},  gt,  false,  true,   true,   "(1,4]",  "(2,4)",  "{(1,4]}",        "{4}",            "{(1,2],4}",      },
        { __LINE__,  {2,4,"(]"},  {1,5,"()"},  gt,  false,  true,   true,   "(1,5)",  "(2,4]",  "{(1,5)}",        "{}",             "{(1,2],(4,5)}",  },
        { __LINE__,  {2,4,"(]"},  {2,3,"()"},  gt,  true,   true,   true,   "(2,4]",  "(2,3)",  "{(2,4]}",        "{[3,4]}",        "{[3,4]}",        },
        { __LINE__,  {2,4,"(]"},  {2,4,"()"},  gt,  true,   true,   true,   "(2,4]",  "(2,4)",  "{(2,4]}",        "{4}",            "{4}",            },
        { __LINE__,  {2,4,"(]"},  {2,5,"()"},  lt,  false,  true,   true,   "(2,5)",  "(2,4]",  "{(2,5)}",        "{}",             "{(4,5)}",        },
        { __LINE__,  {2,4,"(]"},  {3,4,"()"},  lt,  true,   true,   true,   "(2,4]",  "(3,4)",  "{(2,4]}",        "{(2,3],4}",      "{(2,3],4}",      },
        { __LINE__,  {2,4,"(]"},  {3,5,"()"},  lt,  false,  true,   true,   "(2,5)",  "(3,4]",  "{(2,5)}",        "{(2,3]}",        "{(2,3],(4,5)}",  },
        { __LINE__,  {2,4,"(]"},  {4,5,"()"},  lt,  false,  false,  true,   "(2,5)",  "{}",     "{(2,5)}",        "{(2,4]}",        "{(2,5)}",        },
        { __LINE__,  {2,4,"(]"},  {1,2,"[)"},  gt,  false,  false,  false,  "[1,4]",  "{}",     "{[1,2),(2,4]}",  "{(2,4]}",        "{[1,2),(2,4]}",  },
        { __LINE__,  {2,4,"(]"},  {1,3,"[)"},  gt,  false,  true,   true,   "[1,4]",  "(2,3)",  "{[1,4]}",        "{[3,4]}",        "{[1,2],[3,4]}",  },
        { __LINE__,  {2,4,"(]"},  {1,4,"[)"},  gt,  false,  true,   true,   "[1,4]",  "(2,4)",  "{[1,4]}",        "{4}",            "{[1,2],4}",      },
        { __LINE__,  {2,4,"(]"},  {1,5,"[)"},  gt,  false,  true,   true,   "[1,5)",  "(2,4]",  "{[1,5)}",        "{}",             "{[1,2],(4,5)}",  },
        { __LINE__,  {2,4,"(]"},  {2,3,"[)"},  gt,  false,  true,   true,   "[2,4]",  "(2,3)",  "{[2,4]}",        "{[3,4]}",        "{2,[3,4]}",      },
        { __LINE__,  {2,4,"(]"},  {2,4,"[)"},  gt,  false,  true,   true,   "[2,4]",  "(2,4)",  "{[2,4]}",        "{4}",            "{2,4}",          },
        { __LINE__,  {2,4,"(]"},  {2,5,"[)"},  gt,  false,  true,   true,   "[2,5)",  "(2,4]",  "{[2,5)}",        "{}",             "{2,(4,5)}",      },
        { __LINE__,  {2,4,"(]"},  {3,4,"[)"},  lt,  true,   true,   true,   "(2,4]",  "[3,4)",  "{(2,4]}",        "{(2,3),4}",      "{(2,3),4}",      },
        { __LINE__,  {2,4,"(]"},  {3,5,"[)"},  lt,  false,  true,   true,   "(2,5)",  "[3,4]",  "{(2,5)}",        "{(2,3)}",        "{(2,3),(4,5)}",  },
        { __LINE__,  {2,4,"(]"},  {4,5,"[)"},  lt,  false,  true,   true,   "(2,5)",  "4",      "{(2,5)}",        "{(2,4)}",        "{(2,4),(4,5)}",  },
        { __LINE__,  {2,4,"(]"},  {1,2,"(]"},  gt,  false,  false,  true,   "(1,4]",  "{}",     "{(1,4]}",        "{(2,4]}",        "{(1,4]}",        },
        { __LINE__,  {2,4,"(]"},  {1,3,"(]"},  gt,  false,  true,   true,   "(1,4]",  "(2,3]",  "{(1,4]}",        "{(3,4]}",        "{(1,2],(3,4]}",  },
        { __LINE__,  {2,4,"(]"},  {1,4,"(]"},  gt,  false,  true,   true,   "(1,4]",  "(2,4]",  "{(1,4]}",        "{}",             "{(1,2]}",        },
        { __LINE__,  {2,4,"(]"},  {1,5,"(]"},  gt,  false,  true,   true,   "(1,5]",  "(2,4]",  "{(1,5]}",        "{}",             "{(1,2],(4,5]}",  },
        ...
        { __LINE__,  {2,4,"[]"},  {1,5,"()"},  gt,  false,  true,   true,   "(1,5)",  "[2,4]",  "{(1,5)}",        "{}",             "{(1,2),(4,5)}",  },
        { __LINE__,  {2,4,"[]"},  {2,3,"()"},  lt,  true,   true,   true,   "[2,4]",  "(2,3)",  "{[2,4]}",        "{2,[3,4]}",      "{2,[3,4]}",      },
        { __LINE__,  {2,4,"[]"},  {2,4,"()"},  lt,  true,   true,   true,   "[2,4]",  "(2,4)",  "{[2,4]}",        "{2,4}",          "{2,4}",          },
        { __LINE__,  {2,4,"[]"},  {2,5,"()"},  lt,  false,  true,   true,   "[2,5)",  "(2,4]",  "{[2,5)}",        "{2}",            "{2,(4,5)}",      },
        { __LINE__,  {2,4,"[]"},  {3,4,"()"},  lt,  true,   true,   true,   "[2,4]",  "(3,4)",  "{[2,4]}",        "{[2,3],4}",      "{[2,3],4}",      },
        { __LINE__,  {2,4,"[]"},  {3,5,"()"},  lt,  false,  true,   true,   "[2,5)",  "(3,4]",  "{[2,5)}",        "{[2,3]}",        "{[2,3],(4,5)}",  },
        { __LINE__,  {2,4,"[]"},  {4,5,"()"},  lt,  false,  false,  true,   "[2,5)",  "{}",     "{[2,5)}",        "{[2,4]}",        "{[2,5)}",        },
        ...
        { __LINE__,  {2,4,"[]"},  {3,5,"[)"},  lt,  false,  true,   true,   "[2,5)",  "[3,4]",  "{[2,5)}",        "{[2,3)}",        "{[2,3),(4,5)}",  },
        { __LINE__,  {2,4,"[]"},  {4,5,"[)"},  lt,  false,  true,   true,   "[2,5)",  "4",      "{[2,5)}",        "{[2,4)}",        "{[2,4),(4,5)}",  },
        { __LINE__,  {2,4,"[]"},  {1,2,"(]"},  gt,  false,  true,   true,   "(1,4]",  "2",      "{(1,4]}",        "{(2,4]}",        "{(1,2),(2,4]}",  },
        { __LINE__,  {2,4,"[]"},  {1,3,"(]"},  gt,  false,  true,   true,   "(1,4]",  "[2,3]",  "{(1,4]}",        "{(3,4]}",        "{(1,2),(3,4]}",  },
        { __LINE__,  {2,4,"[]"},  {1,4,"(]"},  gt,  false,  true,   true,   "(1,4]",  "[2,4]",  "{(1,4]}",        "{}",             "{(1,2)}",        },
        { __LINE__,  {2,4,"[]"},  {1,5,"(]"},  gt,  false,  true,   true,   "(1,5]",  "[2,4]",  "{(1,5]}",        "{}",             "{(1,2),(4,5]}",  },
        { __LINE__,  {2,4,"[]"},  {2,3,"(]"},  lt,  true,   true,   true,   "[2,4]",  "(2,3]",  "{[2,4]}",        "{2,(3,4]}",      "{2,(3,4]}",      },
        ...
        { __LINE__,  {2,4,"[]"},  {3,5,"(]"},  lt,  false,  true,   true,   "[2,5]",  "(3,4]",  "{[2,5]}",        "{[2,3]}",        "{[2,3],(4,5]}",  },
        { __LINE__,  {2,4,"[]"},  {4,5,"(]"},  lt,  false,  false,  true,   "[2,5]",  "{}",     "{[2,5]}",        "{[2,4]}",        "{[2,5]}",        },
        { __LINE__,  {2,4,"[]"},  {1,1,"[]"},  gt,  false,  false,  false,  "[1,4]",  "{}",     "{1,[2,4]}",      "{[2,4]}",        "{1,[2,4]}",      },
        { __LINE__,  {2,4,"[]"},  {1,2,"[]"},  gt,  false,  true,   true,   "[1,4]",  "2",      "{[1,4]}",        "{(2,4]}",        "{[1,2),(2,4]}",  },
        { __LINE__,  {2,4,"[]"},  {1,3,"[]"},  gt,  false,  true,   true,   "[1,4]",  "[2,3]",  "{[1,4]}",        "{(3,4]}",        "{[1,2),(3,4]}",  },
        { __LINE__,  {2,4,"[]"},  {1,4,"[]"},  gt,  false,  true,   true,   "[1,4]",  "[2,4]",  "{[1,4]}",        "{}",             "{[1,2)}",        },
        { __LINE__,  {2,4,"[]"},  {1,5,"[]"},  gt,  false,  true,   true,   "[1,5]",  "[2,4]",  "{[1,5]}",        "{}",             "{[1,2),(4,5]}",  },
