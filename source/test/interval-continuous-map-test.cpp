...
void test_crow_interval_continuous_interval_map() {
    ...
    TEST_EQUAL(map[8], "charlie");
    TEST_EQUAL(map[9], "charlie");
    TEST_EQUAL(map.str(), "{<=2:alpha,(3,7):bravo,>=8:charlie}");
    ...
    TEST_EQUAL(map.size(), 3u);
    TEST_EQUAL(map.str(), "{<=20:alpha,(30,70):bravo,>=80:charlie}");
...
void test_crow_interval_continuous_interval_map_hashing() {
