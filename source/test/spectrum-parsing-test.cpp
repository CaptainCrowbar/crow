...
void test_crow_spectrum_parsing() {
    ...
    TRY(sp = "cO3"_sp);      TEST_EQUAL(sp.cls(), Sp::O);    TEST_EQUAL(sp.sub(), 3)  TEST_EQUAL(sp.lc(), LC::Ia)
    TRY(sp = "gF6"_sp);      TEST_EQUAL(sp.cls(), Sp::F);    TEST_EQUAL(sp.sub(), 6)  TEST_EQUAL(sp.lc(), LC::III)
    TRY(sp = "sgG7"_sp);     TEST_EQUAL(sp.cls(), Sp::G);    TEST_EQUAL(sp.sub(), 7)  TEST_EQUAL(sp.lc(), LC::IV)
    TRY(sp = "dK8"_sp);      TEST_EQUAL(sp.cls(), Sp::K);    TEST_EQUAL(sp.sub(), 8)  TEST_EQUAL(sp.lc(), LC::V)
    TRY(sp = "sdM9"_sp);     TEST_EQUAL(sp.cls(), Sp::M);    TEST_EQUAL(sp.sub(), 9)  TEST_EQUAL(sp.lc(), LC::VI)
    ...
    TRY(sp = "C1,6-H"_sp);   TEST_EQUAL(sp.cls(), Sp::CH);   TEST_EQUAL(sp.sub(), 1)  TEST_EQUAL(sp.lc(), LC::other)
    TRY(sp = "C2,7-Hd"_sp);  TEST_EQUAL(sp.cls(), Sp::CHd);  TEST_EQUAL(sp.sub(), 2)  TEST_EQUAL(sp.lc(), LC::other)
    TRY(sp = "C3,8-J"_sp);   TEST_EQUAL(sp.cls(), Sp::CJ);   TEST_EQUAL(sp.sub(), 3)  TEST_EQUAL(sp.lc(), LC::other)
    TRY(sp = "C4,9-N"_sp);   TEST_EQUAL(sp.cls(), Sp::CN);   TEST_EQUAL(sp.sub(), 4)  TEST_EQUAL(sp.lc(), LC::other)
    TRY(sp = "C5,10-R"_sp);  TEST_EQUAL(sp.cls(), Sp::CR);   TEST_EQUAL(sp.sub(), 5)  TEST_EQUAL(sp.lc(), LC::other)
    ...
    TRY(sp = "PSR"_sp);      TEST_EQUAL(sp.cls(), Sp::NS);   TEST_EQUAL(sp.sub(), 0)  TEST_EQUAL(sp.lc(), LC::other)
